...
macro(__dkp_toolchain name arch triplet)
	...
	set(TOOL_HINT ${DEVKITPRO}/${name}/${triplet}/bin)
	find_program(CMAKE_ASM_COMPILER gcc        HINTS ${TOOL_HINT})
	find_program(CMAKE_C_COMPILER   gcc        HINTS ${TOOL_HINT})
	find_program(CMAKE_CXX_COMPILER g++        HINTS ${TOOL_HINT})
	find_program(CMAKE_LINKER       ld         HINTS ${TOOL_HINT})
	find_program(CMAKE_AR           gcc-ar     HINTS ${TOOL_HINT})
	find_program(CMAKE_RANLIB       gcc-ranlib HINTS ${TOOL_HINT})
	find_program(CMAKE_STRIP        strip      HINTS ${TOOL_HINT})
	find_program(DKP_OBJCOPY        objcopy    HINTS ${TOOL_HINT})
	find_program(DKP_NM             nm         HINTS ${TOOL_HINT})
